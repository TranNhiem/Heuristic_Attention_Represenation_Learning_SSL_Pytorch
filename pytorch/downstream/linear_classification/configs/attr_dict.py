...
"""
    ...
    Credits: https://aiida.readthedocs.io/projects/aiida-core/en/latest/_modules/aiida/common/extendeddicts.html#AttributeDict  
"""
...
class AttrDict(dict):
    ...
    def to_dict(self):
        ...
        Feeding the configuration to generic functions which only accept primitive type 
        """
        dict = {}
    ...
    def __delattr__(self, key):
        ...
        if key in self:
            ...
            raise AttributeError(
                f"{self.__class__.__name___} object has no attribute {key}."
            )
